package com.usa.sql.helper.util;
import java.sql.*;
...
public class DBTablePrinter {
     ...
     *
     * @param conn DatabaseWholeTableWithJava connection object (java.sql.Connection)
    ...
    public static void printTable(Connection conn, String tableName, int maxRows, int maxStringColWidth) {
        ...
        try {
            ...
            String sqlSelectAll = "SELECT * FROM " + tableName + " Where ROWNUM<= " + maxRows;
